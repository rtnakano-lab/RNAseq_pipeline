...
# Note: Optimized for paired-end reads, unstranded

# prerequisites:
# appropriate edits of 0-config.bash
# list of libraries in a tab-separted text file with a single-line header, containing the name of Libraries in the first column (design file in 0-config.bash)
# raw read files need to be named as "[library_name]_1.fastq.gz" and "[library_name]_2.fastq.gz".
